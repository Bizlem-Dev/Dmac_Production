...
public class DoumentationForKeyHandoverRule {
	...
	public String DoumentationForKeyHandover(String RegistrationId, String ProcessName, String SubProcesName,
			String ProjectCity, String Project, String BuildingCode, String PermittedUse, String BedroomType,
			String ApplicableUnits, String UnitType, String Nationality, String TypeOfCustomer, String POA)

	{
		
//http://localhost:8080/CRM_SR_NEW/services/DoumentationForKeyHandoverRule/DoumentationForKeyHandover?RegistrationId=&ProcessName=&SubProcessName=&ProjectCity=&Project=&BuildingCode=&PermittedUse=&BedroomType=&ApplicableUnits=&UnitType=&Nationality=&TypeOfCustomer=&POA=

		String res = "DoumentationForKeyHandover";
		ConnectionFactory connectionFactory =null;
	  	Connection connection = null;
		try {
			String jsonString = "{\"RegistrationId\":\"" + RegistrationId + "\",\"ProcessName\":\"" + ProcessName
					+ "\",\"SubProcesName\":\"" + SubProcesName + "\",\"ProjectCity\":\"" + ProjectCity
					+ "\",\"Project\":\"" + Project + "\",\"BuildingCode\":\"" + BuildingCode + "\",\"PermittedUse\":\""
					+ PermittedUse + "\",\"BedroomType\":\"" + BedroomType + "\",\"ApplicableUnits\":\""
					+ ApplicableUnits + "\",\"UnitType\":\"" + UnitType + "\",\"Nationality\":\"" + Nationality
					+ "\",\"TypeOfCustomer\":\"" + TypeOfCustomer + "\",\"POA\":\"" + POA + "\"}";
			//
			...
			Destination destination = session
					.createQueue("DoumentationForKeyHandoverRule.RULE.DoumentationForKeyHandoverUAT"); // **************queue
			// name***************
