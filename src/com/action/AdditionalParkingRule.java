...
public class AdditionalParkingRule {
	...
	public String AdditionalParkingDetails(String RegistrationId, String ProcessName, String SubProcessName,
			String SourceofRequest, String ProjectCity, String Project, String BuildingCode, String BedroomType,
			String UnitType, String PermittedUse, String Units, String ReadyOffPlan, String NoofParkingRequiredLessthan,
			String NoofParkingRequiredgreaterthan, String CustomerClassification, String AggrementStatus) {
		String res = "AdditionalParkingDetails";
		ConnectionFactory connectionFactory =null;
	  	Connection connection = null;
		// http://localhost:8080/CRM_SR_NEW/services/AdditionalParkingRule/AdditionalParkingDetails?RegistrationId=22&ProcessName=&SubProcessName=&SourceofRequest=&ProjectCity=&Project=&BuildingCode=&BedroomType=&UnitType=&PermittedUse=&Units=&ReadyOffPlan=&NoofParkingRequiredLessthan=&NoofParkingRequiredgreaterthan=&CustomerClassification=&AggrementStatus=
		try {
			String jsonString = "{\"RegistrationId\":\"" + RegistrationId + "\",\"ProcessName\":\"" + ProcessName
					+ "\",\"SubProcessName\":\"" + SubProcessName + "\",\"SourceofRequest\":\"" + SourceofRequest
					+ "\"," + "\"ProjectCity\":\"" + ProjectCity + "\",\"Project\":\"" + Project
					+ "\",\"BuildingCode\":\"" + BuildingCode + "\",\"BedroomType\":\"" + BedroomType
					+ "\",\"UnitType\":\"" + UnitType + "\",\"PermittedUse\":\"" + PermittedUse + "\",\"Units\":\""
					+ Units + "\"," + "\"ReadyOffPlan\":\"" + ReadyOffPlan + "\",\"NoofParkingRequiredLessthan\":\""
					+ NoofParkingRequiredLessthan + "\",\"NoofParkingRequiredgreaterthan\":\""
					+ NoofParkingRequiredgreaterthan + "\",\"CustomerClassification\":\"" + CustomerClassification
			...
			Destination destination = session.createQueue("ADDITIONALPARKINGRULE.RULE.ADDITIONALPARKINGDETAILSUAT"); // **************queue
																													// name***************
