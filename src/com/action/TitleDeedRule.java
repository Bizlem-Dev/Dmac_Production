...
public class TitleDeedRule {
	...
	public String TitleDeedDetails(String RegistrationId, String ProcessName, String SubProcessName, String ProjectCity,
			String Project, String BuildingCode, String PermittedUse, String BedroomType, String UnitType,
			String CustomerType, String ModeofRequest, String UnderAssignment) {
		String res = "TitleDeedDetails";
		ConnectionFactory connectionFactory =null;
	  	Connection connection = null;
		// http://localhost:8080/CRM_SR_NEW/services/TitleDeedRule/TitleDeedDetails?RegistrationId=14&ProcessName=&SubProcessName=&ProjectCity=&Project=&BuildingCode=&PermittedUse=&BedroomType=&UnitType=&CustomerType=&ModeofRequest=&UnderAssignment=
		try {
			String jsonString = "{\"RegistrationId\":\"" + RegistrationId + "\",\"ProcessName\":\"" + ProcessName
					...
					+ PermittedUse + "\",\"BedroomType\":\"" + BedroomType + "\",\"UnitType\":\"" + UnitType
					+ "\",\"CustomerTpye\":\"" + CustomerType + "\",\"ModeofRequest\":\"" + ModeofRequest
			...
			Destination destination = session.createQueue("TITLEDEED.RULE.TITLEDEEDDETAILSUAT"); // **************queue
																								// name***************
