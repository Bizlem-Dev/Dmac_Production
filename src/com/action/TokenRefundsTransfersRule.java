...
public class TokenRefundsTransfersRule {
	...
	public String TokenRefundsTransfers(String RegistrationId, String ProcessName, String SubProcessName,
			String ProjectCity, String Project, String BuildingCode, String BedroomType, String UnitType,
			String PermittedUse, String Units, String ReadyOffPlan, String EHOFlag, String HOFlag,
			String ApplicableNationality, String CustomerClassification, String PortfolioValue,
			String refundAmount,String extra1,String extra2,String extra3,String extra4,String extra5,String extra6,
			String extra7,String extra8) {
		String res = "TokenRefundsTransfers";
		ConnectionFactory connectionFactory =null;
	  	Connection connection = null;
		// url
		// http://localhost:8080/CRM_SR_NEW/services/TokenRefundsTransfersRule/TokenRefundsTransfers?RegistrationId=&ProcessName=&SubProcessName=&ProjectCity=&Project=&BuildingCode=&BedroomType=&UnitType=&PermittedUse=&Units=&ReadyOffPlan=&EHOFlag=&HOFlag=&ApplicableNationality=&CustomerClassification=&PortfolioValueLessthan=&PortfolioValueGreaterthan=
		try {
			String jsonString = "{\"RegistrationId\":\"" + RegistrationId + "\",\"ProcessName\":\"" + ProcessName
					...
					+ "\",\"Project\":\"" + Project + "\",\"BuildingCode\":\"" + BuildingCode + "\",\"BedroomType\":\""
					+ BedroomType + "\",\"UnitType\":\"" + UnitType + "\",\"PermittedUse\":\"" + PermittedUse
					+ "\",\"Units\":\"" + Units + "\",\"ReadyOffPlan\":\"" + ReadyOffPlan + "\",\"EHO\":\""
					+ EHOFlag + "\",\"HO\":\"" + HOFlag + "\",\"ApplicableNationality\":\"" + ApplicableNationality
			...
			Destination destination = session.createQueue("TOKENREFUNDSTRANSFERSRULE.RULE.TOKENREFUNDSTRANSFERSUAT"); // **************queue
																													// name***************
