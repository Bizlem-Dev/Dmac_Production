...
public class FMPCC {
	final static Logger logger = Logger.getLogger(FMPCC.class);
	public com.activeMQ.ActiveMQCall activemqcall = null;

	
	public  String fmPcc(String P_REQUEST_NUMBER,String P_REQUEST_NAME,String P_SOURCE_SYSTEM, com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.APPSXXDC_PROCESS_SERX1794747X1X5[]  regTerms) {
			final String queueName = "IPMS.FMPCC";
			...
			activemqcall=new ActiveMQCall();
	   		...
	   		com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.APPSXXDC_PROCESS_SERX1794747X1X5[] arr = null;
	   		com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.APPSXXDC_PROCESS_SERX1794747X1X5 objX41 = null;
	   		com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.OutputParameters param = null;
	   		APPSXXDC_PROCESS_SEX1794747X1X57[] objAPPSXXDC_PROCESS_SEX1794747X1X57 = null;
	   		try {
	   	    ...
	   	    arr = new com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.APPSXXDC_PROCESS_SERX1794747X1X5[regTerms.length];
	   		
	   		for(int j=0;j<regTerms.length;j++) {
	   		objX41 = new com.oracle.xmlns.apps.ont.soaprovider.plsql.xxdc_process_service_ws.process.APPSXXDC_PROCESS_SERX1794747X1X5();
	   		...
	   		param = port.PROCESS(header, body);
...
//	   		
	   		...
	   		objAPPSXXDC_PROCESS_SEX1794747X1X57 = param.getX_RESPONSE_MESSAGE();
	   		for(int i=0;i<objAPPSXXDC_PROCESS_SEX1794747X1X57.length;i++) {
	   			...
	   			logger.info("FMPCC param id response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getPARAM_ID());
	   			logger.info("FMPCC PROC_STATUS response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getPROC_STATUS());
	   			logger.info("FMPCC PROC_Message response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getPROC_MESSAGE());
	   			logger.info("FMPCC ATTRIBUTE1 response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getATTRIBUTE1());
	   			logger.info("FMPCC ATTRIBUTE2 response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getATTRIBUTE2());
	   			logger.info("FMPCC ATTRIBUTE3 response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getATTRIBUTE3());
	   			logger.info("FMPCC ATTRIBUTE4 response :: "+objAPPSXXDC_PROCESS_SEX1794747X1X57[i].getATTRIBUTE4());
	   		...
	   		//return param.getX_RETURN_STATUS();
	   			...
	   			service = null;
	   			header = null;
	   			objAPPSXXDC_PROCESS_SEX1794747X1X57 = null;
	   			objX41 = null;
